...
{
    return [self initWithFrame:frame text:text color:kNORMAL_TEXT_COLOR font:[KKFitTool fitWithTextHeight:13.0f] alignment:NSTextAlignmentLeft];
}
...
+(instancetype)getLableWithTerminalOutputType:(TerminalOutputType)type{
    KKLabel *lable = [[KKLabel alloc]initWithFrame:CGRectMake(0, 0, 12, 12)];
    lable.textAlignment = NSTextAlignmentCenter;
    lable.font = kFONT_9;
    lable.layer.cornerRadius = lable.frame.size.height/2;
    lable.layer.masksToBounds = YES;
    lable.textColor = kBACKGROUND_COLOR;
    lable.backgroundColor = kFOURTH_LEVEL_COLOR;
    switch (type) {
        case TerminalOutputNumberFirst:
        {
            lable.text = @"1";
//            lable.backgroundColor = kTERMINAL_HEAD_1_COLOR;
        }
            break;
        case TerminalOutputNumberSecond:
        {
            lable.text = @"2";
//            lable.backgroundColor = kTERMINAL_HEAD_2_COLOR;
        }
            break;
        case TerminalOutputNumberThird:
        {
            lable.text = @"3";
//            lable.backgroundColor = kTERMINAL_HEAD_3_COLOR;
        }
            break;
        case TerminalOutputNumberFourth:
        {
            lable.text = @"4";
//            lable.backgroundColor = kTERMINAL_HEAD_4_COLOR;
        }
            break;
        default:
        {
            lable.text = @"1";
//            lable.backgroundColor = kDISABLE_BUTTON_COLOR;
        }
            break;
    }
    return lable;
