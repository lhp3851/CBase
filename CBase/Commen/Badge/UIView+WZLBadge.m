...
static const CGFloat kWZLBadgeDefaultRedDotRadius = 2.5f;
...
- (void)badgeInit
{
    ...
    if (nil == self.badge) {
        ...
        self.badge.center = CGPointMake(CGRectGetWidth(self.frame) + 2 + self.badgeCenterOffset.x-3.5, self.badgeCenterOffset.y+2);
