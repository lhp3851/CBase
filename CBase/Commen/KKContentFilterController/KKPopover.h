...
@protocol KKPopoverDelegate <NSObject>
...
typedef NS_ENUM(NSUInteger, KKPopoverPosition) {
    KKPopoverPositionUp = 1,
    KKPopoverPositionDown,
};

typedef NS_ENUM(NSUInteger, KKPopoverMaskType) {
    KKPopoverMaskTypeBlack,
    KKPopoverMaskTypeNone,  // overlay does not respond to touch
};

@interface KKPopover : UIView

+ (instancetype)popover;

-(void)cleanView;

@property(nonatomic,weak)id<KKPopoverDelegate>delegate;
 ...
 */
@property (nonatomic, assign, readonly) KKPopoverPosition popoverPosition;
 ...
 */
@property (nonatomic, assign) KKPopoverMaskType maskType;
